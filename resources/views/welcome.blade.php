...
<head>
  ...
  <!-- General CSS Files -->
  <link rel="stylesheet" href="{{url('vendor/assets/modules/bootstrap/css/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{url('vendor/assets/modules/fontawesome/css/all.min.css')}}">

  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{url('vendor/assets/modules/jqvmap/dist/jqvmap.min.css')}}">
  <link rel="stylesheet" href="{{url('vendor/assets/modules/summernote/summernote-bs4.css')}}">
...
<body>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="{{url('vendor/assets/img/products/product-3-50.png')}}" alt="product">
                  oPhone S9 Limited Edition
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="{{url('vendor/assets/img/products/product-2-50.png')}}" alt="product">
                  Drone X2 New Gen-7
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="{{url('vendor/assets/img/products/product-1-50.png')}}" alt="product">
                  Headphone Blitz
                </a>
              </div>
              <div class="search-header">
        ...
        <ul class="navbar-nav navbar-right">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="{{url('vendor/assets/img/avatar/avatar-1.png')}}" class="rounded-circle">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="{{url('vendor/assets/img/avatar/avatar-2.png')}}" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Dedik Sugiharto</b>
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="{{url('vendor/assets/img/avatar/avatar-3.png')}}" class="rounded-circle">
                    <div class="is-online"></div>
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="{{url('vendor/assets/img/avatar/avatar-4.png')}}" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="{{url('vendor/assets/img/avatar/avatar-5.png')}}" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Alfa Zulkarnain</b>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="{{url('vendor/assets/img/avatar/avatar-1.png')}}" class="rounded-circle mr-1">
  ...
  <!-- General JS Scripts -->
  <script src="{{url('vendor/assets/modules/jquery.min.js')}}"></script>
  <script src="{{url('vendor/assets/modules/popper.js')}}"></script>
  <script src="{{url('vendor/assets/modules/tooltip.js')}}"></script>
  <script src="{{url('vendor/assets/modules/bootstrap/js/bootstrap.min.js')}}"></script>
  <script src="{{url('vendor/assets/modules/nicescroll/jquery.nicescroll.min.js')}}"></script>
  <script src="{{url('vendor/assets/modules/moment.min.js')}}"></script>
  <script src="{{url('vendor/assets/js/stisla.js')}}"></script>

  <!-- JS Libraies -->
  <script src="{{url('vendor/assets/modules/jquery.sparkline.min.js')}}"></script>
  <script src="{{url('vendor/assets/modules/chart.min.js')}}"></script>
  <script src="{{url('vendor/assets/modules/owlcarousel2/dist/owl.carousel.min.js')}}"></script>
  <script src="{{url('vendor/assets/modules/summernote/summernote-bs4.js')}}"></script>
  <script src="{{url('vendor/assets/modules/chocolat/dist/js/jquery.chocolat.min.js')}}"></script>

  <!-- Page Specific JS File -->
  <script src="{{url('vendor/assets/js/page/index.js')}}"></script>

  <!-- Template JS File -->
  <script src="{{url('vendor/assets/js/scripts.js')}}"></script>
  <script src="{{url('vendor/assets/js/custom.js')}}"></script>
</body>
</html>
